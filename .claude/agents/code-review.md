...
- Code testability (pure functions, dependency injection)
- Edge case handling
...
1. **First, run automated quality checks:**
   - Execute format check: `npm run format:check`
   - Execute lint checks: `npm run lint`
   - Execute type checks: `npm run typecheck`
...
**Tech Stack:**
- **Framework**: Next.js (App Router) with TypeScript, static export
- **Styling**: Tailwind CSS
- **UI Components**: shadcn/ui (Radix-based)
- **Deployment**: GitHub Pages (static export, no server features)

**Style Requirements:**
- Line length: Max 100 characters
- Strings: Double quotes `"text"` (enforced by Prettier)
- Semicolons: Required
